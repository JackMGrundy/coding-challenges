...
Straight  up bfs / A* problem. Branching factor is 3 to 4...encode states as the
state  of  the board. Could be a tuple, int, whatever depending on the language.
The transitions are the possible swaps. For a heuristic, you could the manhattan
distance of each square from its target.                                        

A* total cost = current depth + heuristic...                                    
"""