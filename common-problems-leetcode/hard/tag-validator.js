...
all the subsequent characters until the next > should be parsed as TAG_NAME (not
necessarily valid).                                                             
...
validator  to  parse  CDATA_CONTENT,  so even it has some characters that can be
